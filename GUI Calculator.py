# Basic GUI Calculator using Tkinter in Python

from tkinter import *
root=Tk()
root.title("Harsh Calculator")
# creating main frame
mainframe=Frame(root,width=45,bd=10,relief=RIDGE,bg="Black")
mainframe.pack()
inner=Frame(mainframe,width=45,bd=10,relief=RIDGE,bg="Red")
inner.pack()
